...
#        new_HLA = np.vstack((HLA, HLA[exception_index]))
    ...
    return TCR, new_HLA, CMV, train_index, test_index, AA_index
...
if __name__ == "__main__":
    ...
    parser.add_argument('--hla_id', type=int, help='the index of HLA (among HLA-IIs) to run permutation for in integer format')
