...
HLA_II = pd.read_csv("../../data/HLA_II_pseudo_45.csv", header = 0)
HLA_II.shape
...
# compute alignment score for each pair of pseudo sequences
...
pseudo_seqs = HLA_II.seq.to_list()
...
df_score = pd.DataFrame(score_lists, columns = HLA_II.hla.to_list())


df_score.to_csv("../../data/blosum62_X_seq_align_score_HLA_II.csv", index = False)
